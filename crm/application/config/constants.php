...
define('TBL_PRFFIX','ch_');
define('NEWS_LETTER_SUBSCRIBERS',TBL_PRFFIX.'subcribers_news_letters');
define('WEB_ENQUIRIES',TBL_PRFFIX.'web_enquiries');
define('APP_USERS',TBL_PRFFIX.'app_users');
