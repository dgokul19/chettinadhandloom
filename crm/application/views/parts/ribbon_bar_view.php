    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item"><a href="" class="navbar-brand nav-link"><img alt="branding logo" src="<?= ASSETS ?>adminApp/core/appIcon.png" data-expand="<?= ASSETS ?>adminApp/core/appIcon.png" data-collapse="<?= ASSETS ?>adminApp/core/appIcon.png" class="brand-logo" style="width: 5em;"></a></li>
